...
const Student = (studentName, course, term = 1) => {
  return {
      ...
      getAverage: function (courseToFind = this.course, term = this.term - 1) {
        ...
        const term = foundCourse.terms[termToFind - 1];
        
        return getMeanAverage(term.grades)
      ...
      function generateHashtag (str) {
        ...
        let strSplittedArray = str.split(' ');
        
          for(const eachWord of strSplittedArray) {
            eachWord[0].toUpperCase;
          }
          
          let finalResult = '#' + strSplittedArray.concat;
